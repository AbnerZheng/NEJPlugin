package old_do_more_dojo.intellij.components;
...
public class DojoSettingsDetectionComponent implements ProjectComponent {
    ...
    private class SetupNotification implements NotificationListener {
        ...
        public void hyperlinkUpdate(@NotNull Notification notification, @NotNull HyperlinkEvent hyperlinkEvent) {
            ...
            {
                ServiceManager.getService(project, NEJSettings.class).setNeedsMoreDojoEnabled(false);
            ...
            {
                ServiceManager.getService(project, NEJSettings.class).setSetupWarningDisabled(true);
                notification.hideBalloon();
